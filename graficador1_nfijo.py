...
data_random_todo = pd.read_csv('experimentos/problema1/nfijo/arista_random_premium_random.csv')
tiempos_random_todo = data_random_todo.groupby('n')['tiempo'].mean() / 1000000000

data_premium_minimas = pd.read_csv('experimentos/problema1/nfijo/arista_random_premium_minimas.csv')
tiempos_premium_minimas = data_premium_minimas.groupby('n')['tiempo'].mean() / 1000000000

data_premium_maximas = pd.read_csv('experimentos/problema1/nfijo/arista_random_premium_maximas.csv')
tiempos_premium_maximas = data_premium_maximas.groupby('n')['tiempo'].mean() / 1000000000

data_premium_25 = pd.read_csv('experimentos/problema1/nfijo/arista_random_premium_25.csv')
tiempos_premium_25 = data_premium_25.groupby('n')['tiempo'].mean() / 1000000000

data_premium_10 = pd.read_csv('experimentos/problema1/nfijo/arista_random_premium_10.csv')
tiempos_premium_10 = data_premium_10.groupby('n')['tiempo'].mean() / 1000000000

data_premium_3 = pd.read_csv('experimentos/problema1/nfijo/arista_random_premium_3.csv')
tiempos_premium_3 = data_premium_3.groupby('n')['tiempo'].mean() / 1000000000

data_premium_0_5 = pd.read_csv('experimentos/problema1/nfijo/arista_random_premium_0_5.csv')
...
plot_premium_maximas.set_xlabel("K: Cantidad maxima de rutas premium que pueden usarse", size=14)
