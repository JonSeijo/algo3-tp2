...
{\centering
	\includegraphics[width=0.5\textwidth]{imagenes/problema1/problema1-c2.png} \\
}

{\centering
	\includegraphics[width=0.5\textwidth]{imagenes/problema1/problema1-c2-solved.png} \\
	\captionof{figure}{Solución óptima con K = 1}
}

\todo[inline]{Agregar explicacion del ejemplo}
