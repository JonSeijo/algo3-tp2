...
$ $ \newline
La estrategia general va a ser plantearse $k$ versiones para cada nodo, donde cada uno representa un \textit{estado} distinto: el nodo $v$ en el estado $j$, es el nodo $v$ habiendo pasado por $j$ rutas premiums previamente. Habiendo hecho esta separación, simplificamos los roles de los ejes premium, y nos permite aplicar el algoritmo de Dijkstra, con algunas leves variaciones.
