...
Al modificar $K$, los costos de cada arista disminuyen en $K$ con respecto al grafo inicial. Queremos encontrar el máximo $K$ tal que la suma de los costos de los peajes no sea negativa. En otras palabras, queremos encontrar el máximo $K$ tal que no se formen ciclos negativos. Observamos que con $K = 2$ existe un ciclo negativo si pasamos por los nodos 1-2-4-3-1, pero no existe ningun ciclo negativo con $K = 1$. Por lo tanto, el valor maximo (y respuesta final) en este ejemplo es $1$. \\
