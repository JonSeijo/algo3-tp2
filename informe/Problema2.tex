...
En principio, podríamos ir fijando algunas de las variables y variando una para ver cómo afecta cada variable a los tiempos de cómputo. Sin embargo, esto no es particularmente interesante, lo único que tendriamos es un gráfico creciente. \\

\todo[inline]{Uhh.... Se me acabó la imaginación, pero hay que dar un verso para la hipótesis}

\todo[inline]{Faltan datos puros y duros de cómo se generó el experimento}

{\centering
  \includegraphics[width=0.8\textwidth]{imagenes/problema2/n_aristas.png} \\
}

\todo[inline]{Wait, ¿qué pasa con el $c$ acá? ¿Se fija?}
