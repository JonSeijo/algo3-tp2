...
Con estos resultados estamos bastante convencidos de lo que que sospechabamos en un principio: lo único que cambia el tiempo de cómputo del algoritmo es $n$, sin importar las variaciones entre las diferentes posibilidades de costos o existencias. \\
